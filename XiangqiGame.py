...
class Advisor(Piece):
    ...
    def legal_move_test(self, new_pos):
        ...
        if new_pos == [cp[0]+1, cp[1]+1] or new_pos == [cp[0]-1, cp[1]+1] or new_pos == [cp[0]+1, cp[1]+1] or new_pos == [cp[0]+1, cp[1]-1]:
            return True
...
class Elephant(Piece):
    ...
    def legal_move_test(self, new_pos):
        ...
        new_pos_test_list = [[cp[0]+2, cp[1]+2], [cp[0]+2, cp[1]-2], [cp[0]-2, cp[1]+2], [cp[0]-2, cp[1]-2]]
...
class Horse(Piece):
    ...
    def legal_move_test(self, new_pos):
        ...
        new_pos_test_list = [[cp[0]+2, cp[1]+1], [cp[0]+2, cp[1]-1], [cp[0]-2, cp[1]+1], [cp[0]-2, cp[1]-1],
                             [cp[0]+1, cp[1]+2], [cp[0]-1, cp[1]+2], [cp[0]+1, cp[1]-2], [cp[0]-1, cp[1]-2]]
                    ...
                    for col in self._col_dimensions:
                        ...
                        if piece.legal_move_test([row, col]) == True:
                            if board[row][col] == "_______" or board[row][col].get_piece_color() != color:
                                ...
                                board[o_pos[0]][o_pos[1]] = "_______"       # Temporarily move the testing piece to do a in check test
                                board[row][col] = piece
